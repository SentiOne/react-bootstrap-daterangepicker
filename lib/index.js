 ...
 *
 * Changelist:
 * 22.01 Paweł Olesiejuk Added dateRange to help selecting proper label - see bug DEV-8264
 *
...
module.exports = createReactClass({
  ...
  initializeDateRangePicker: function() {
    ...
    $this.setOptionsFromProps($this.getOptionsFromProps());
  },
  propTypes: {
    ...
    dateRange: React.PropTypes.string, // is helping to select proper item - see bug DEV-8264
